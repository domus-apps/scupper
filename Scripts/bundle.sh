#!/bin/bash
# Builds a standalone Scupper.app at build/Scupper.app.
set -euo pipefail
cd "$(dirname "$0")/.."

swift build -c release

APP=build/Scupper.app
rm -rf "$APP"
mkdir -p "$APP/Contents/MacOS" "$APP/Contents/Resources"
cp .build/release/Scupper "$APP/Contents/MacOS/Scupper"
...
# Sources/Scupper/Localization.swift — the generated accessor can't be
# trusted across toolchains).
cp -R .build/release/Scupper_Scupper.bundle "$APP/Contents/Resources/"
...
# Otherwise fall back to ad-hoc, which is fine locally — Scupper needs no
