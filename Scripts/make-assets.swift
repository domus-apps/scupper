#!/usr/bin/env swift
// Generates the app icon (Assets/AppIcon.iconset/*.png + icon-1024.png), the
// Icon Composer layer (Assets/AppIcon.icon/Assets/front.png), the README
// banner (Assets/banner.png) and the GitHub social preview (Assets/og-image.png)
// programmatically, so the artwork is reproducible from source.
