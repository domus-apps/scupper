...
ITEM=$(mktemp)
{
    cat <<EOF
    <item>
      <title>Scupper v$VERSION</title>
      <link>https://github.com/domus-apps/scupper/releases/tag/v$VERSION</link>
...
EOF
    ...
    cat <<EOF
      ...
      <enclosure
        url="https://github.com/domus-apps/scupper/releases/download/v$VERSION/Scupper.zip"
        $SIGNATURE_ATTRS
